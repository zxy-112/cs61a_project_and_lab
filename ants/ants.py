...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        current_range = 0
        while current_range < self.min_range and current_place is not None and current_place is not beehive:
            current_place = current_place.entrance
            current_range += 1
        while current_place is not None and current_place is not beehive and current_range <= self.max_range:
            if current_place.bees:
                return choice(current_place.bees)
            current_place = current_place.entrance
            current_range += 1
        return None
        # END Problem 3 and 4
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        reflect_damage = amount if amount < self.armor else amount + self.damage
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting == 0 and self.place.bees:
            self.eat_bee(choice(self.place.bees))
        else:
            if self.digesting != 0:
                self.digesting -= 1
        # END Problem 6
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        if QueenAnt.true_exist:
            pass
        else:
            self.is_true_queen = True
            QueenAnt.true_exist = True
        # END Problem 13
    ...
    def action(self, gamestate):
        ...
        if self.is_true_queen:
            ...
            while current_place is not None:
                ...
                if isinstance(current_ant, ContainerAnt):
                    if current_ant.contained_ant:
                        if hasattr(current_ant.contained_ant, 'doubled'):
                            pass
                        else:
                            current_ant.contained_ant.doubled = True
                            current_ant.contained_ant.damage *= 2
                if isinstance(current_ant, Ant):
                    if hasattr(current_ant, 'doubled'):
                        pass
                    else:
                        current_ant.doubled = True
