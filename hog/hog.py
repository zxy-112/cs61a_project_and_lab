...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if feral_hogs:
                if abs(num_rolls0 - diff0) == 2:
                    bonus = 3
                else:
                    bonus = 0
            else:
                bonus = 0
            diff0 = take_turn(num_rolls0, score1, dice)
            score0 += diff0 + bonus
            ...
            if feral_hogs:
                if abs(num_rolls1 - diff1) == 2:
                    bonus = 3
                else:
                    bonus = 0
            else:
                bonus = 0
            diff1 = take_turn(num_rolls1, score0, dice)
            score1 += diff1 + bonus
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            new_score = score1
        if diff > running_high and not(score0 == 0 and score1 == 0):
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    point_roll_0 = 10 - opponent_score % 10 + opponent_score//10%10
    if point_roll_0 >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    gain_score = free_bacon(opponent_score)
    if is_swap(score + gain_score, opponent_score):
        if opponent_score - score >= cutoff or score + gain_score < opponent_score:
            return 0
        else:
            return num_rolls
    elif gain_score >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
