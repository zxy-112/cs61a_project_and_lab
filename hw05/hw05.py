...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, psw):
        ...
        if len(wrong_attempt) == 3:
            return "Too many incorrect attempts. Attempts: {}".format(wrong_attempt)
        elif psw == password:
            if amount > balance:
                return 'Insufficient funds'
            else:
